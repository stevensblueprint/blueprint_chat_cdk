    ...
    new LambdaLlmProxyConstruct(this, "LambdaLlmProxy", {
      monthlyLimit: 6.6,
		...
		new WebhookLambdaConstruct(this, "NotionWebhookLambda", {
			...
			description: "Lambda function to handle Notion webhooks and store documents in S3",
		...
		new WebhookLambdaConstruct(this, "DiscordWebhookLambda", {
			...
			description: "Lambda function to handle Discord webhooks and store documents in S3",
			documentBucket: documentBucket,
			environmentVariables: {
		...
		new WebhookLambdaConstruct(this, "DriveWebhookLambda", {
			...
			description: "Lambda function to handle Google Drive webhooks and store documents in S3",
			documentBucket: documentBucket,
			environmentVariables: {
		...
		new WebhookLambdaConstruct(this, "WikiWebhookLambda", {
			...
			description: "Lambda function to handle Wiki webhooks and store documents in S3",
			documentBucket: documentBucket,
			environmentVariables: {
